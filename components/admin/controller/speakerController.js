       ...
       if(user)
       {
        ...
        var password =random();
            ...
            .then(data => {
                ...
                Mail.sendMailer({email:em,body:html,subject:'Registration successfully'}); 
...
module.exports.editSpeaker = async(req,res)=>
{
    ...
    { 
       ...
       else
       {
          ...
          let right_active = 'Speaker';
          let left_side = 'active';
         res.render('speaker/edit_speaker',{layout: 'layouts/eventLayout',event_id,active,title,right_active,left_side,errors:req.flash("errors"),data,company_data});
        }
    });
}
